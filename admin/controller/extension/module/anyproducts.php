<?php 
class ControllerExtensionModuleAnyproducts extends Controller {
	private $error = array(); 
	...
	public function index() {
		...
		$this->load->language('extension/module/anyproducts');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/anyproducts', $token_prefix . '=' . $this->session->data[$token_prefix], true)); 
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/anyproducts', $token_prefix . '=' . $this->session->data[$token_prefix], true)
		);			
		

		$data['action'] = $this->url->link('extension/module/anyproducts', $token_prefix . '=' . $this->session->data[$token_prefix], true);
		...
		$this->response->setOutput($this->load->view('extension/module/anyproducts', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/anyproducts')) {
