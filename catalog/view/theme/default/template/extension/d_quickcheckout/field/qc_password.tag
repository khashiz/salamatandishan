    ...
    <div if={  isVisible() } class="field-sortable d-vis ve-clearfix { (opts.error &&  isVisible()) ? 've-field--error' : ''}">
        ...
        <div>
            <input
                ...
                class="uk-input uk-border-rounded uk-width-1-1 uk-text-right uk-text-secondary font ve-inpu d-vis validate { isRequired() ? 'qc-required' : 'qc-not-required'} { opts.field.type } { opts.field.id }"
